...
- "Edge" or "network tie" = off-campus recruiting vist
...
- university $i$ and university $j$ share an edge if they visit at least one high school in common
- "Weight" of the edge is number of high schools visited by both $i$ and $j$
...
### One-mode percent matrix, all universities {.caption}
...
### All recruiting visits, public research universities {.caption}
