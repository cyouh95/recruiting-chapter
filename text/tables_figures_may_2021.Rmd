...
```{r plot-1mode-all, fig.align = 'center', echo = FALSE, eval=FALSE, out.width = "100%", fig.cap = "One-mode network for public universities, private universities, private liberal arts, colored by cluster"}
...
```{r two-mode-plot, fig.align = 'center', echo = FALSE, eval=FALSE, out.width = "100%", fig.cap = "2-mode network for all institutions, colored by geographic region"}
# <!-- plot of two-mode network; exclude for now -->
