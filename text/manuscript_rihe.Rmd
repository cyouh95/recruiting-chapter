...
In the early twenty-first century, "privatization" received substantial attention from scholars of higher education [e.g., @RN921; @RN2101; @RN1118; @RN1577; @RN2111]. @RN4543 argue that scholarship on privatization waned because of a lack of conceptual and empirical clarity. One strand of scholarship conceptualizes privatization as a process whereby declines in government funding cause public institutions to grow alternative revenue sources. Public research universities responded, for example, by pursuing research commercialization and nonresident tuition revenue, and donative resources [e.g., @RN3753; @RN2101; @RN1644]. A second strand within the privatization literature conceptualizes privatization as a process whereby public institutions become more similar -- in terms of characteristics or behavior -- to for-profit or private non-profit organizations [@RN4543]. A weakness of this literature is that few empirical studies analyze public institutions on a behavior associated with private institutions. Moreover, few studies directly compare public and private institutions on the same behavioral dimension.

We argue that scholarship on recruiting behavior can shed light on the extent to which public universities are engaging in behaviors associated with private universities. Admissions counselors from colleges and universities visit local high schools in order to meet prospective students and maintain relationships with guidance counselors at feeder schools [@RN3519]. @RN4758 analyzed off-campus recruiting visits made in 2017 by 15 public research universities, finding that 12 of these universities made more visits to *out-of-state* high schools than *in-state* high schools. These out-of-state visits focused on public schools in affluent, predominantly white communities. Whereas @RN4758 primarily analyzed visits to public high schools, this chapter focuses on visits to private high schools. More specifically, we investigate how visits to private high schools by public research universities compare to visits to private high schools by selective private universities.

Our focus on recruiting visits to private high schools is motivated by seminal scholarship within the sociology of education. Sociologist Max Weber is credited for the insight that education has a "dual character," on one hand, serving *social mobility* by redistributing access to privileged positions and, on the other, serving *social reproduction* by granting privileged families disproportionate access to the educational institutions that confer pathways to privileged positions [@RN2377; @RN1133].
...
This manuscript compares public research universities to selective private universities on the dimension of recruiting visits to private high schools, a behavior associated with the social reproduction orientation of selective private universities. Our primary goal is to learn about public research universities, using the behavior of private universities as a benchmark to develop more thoughtful insights about public research universities. We analyze recruiting visits made in the 2017 calendar year by a sample of 15 public research universities and 14 selective private universities. 
<!-- and 12 selective private liberal arts colleges. -->
...
The remainder of the manuscript is organized as follows. First, we situate off-campus recruiting visits within the broader process of recruiting students and we review scholarship on the relationship between high schools and universities, focusing on scholarship from sociology. This literature motivates off-campus recruiting visits as an indicator of a social relation. Second, we introduce concepts from social network analysis and motivate empirical research questions. Third, we describe data and methods. Fourth, we present results. Finally, we discuss implications for scholarship.
...
Analyses consist of simple descriptive statistics and descriptive social network analyses.
