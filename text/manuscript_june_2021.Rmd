...
Figure \@ref(fig:plot-1mode-pubu) shows the University of Alabama, University of South Carolina, and CU-Boulder at the center of the recruiting network. The University of Nebraska-Lincoln, SUNY Stony Brook and UC-Riverside are located on the periphery, and the remaining universities are in-between. Universities that share many direct (i.e., visit many of the same schools) or indirect edges tend to be located close together, for example University of Kansas and University of Arkansas, University of Geogia and UC-Berkeley. 

To better answer research question 3, we augment the network graphs by using cluster analysis to identify universities that share common network structure. Social network. Referred to as "community detection" in the literature, social network methodologists have developed many alternative algorithms to categorized vertices into a small number of groups (or clusters) based purely on patterns of network ties [@RN4725]. Generally, groups are chosen to maximize the number of within-group ties while minimizing ties between members of different groups. We performed hierarchical cluster analysis to allocate universities into clusters, directing the algorithm to identify four groups. 

The shape of each university vertex in Figure \@ref(fig:plot-1mode-pubu) is determined by this cluster analysis. These clusters are largely consistent with physical layout of vertices in Figure \@ref(fig:plot-1mode-pubu).  The University of Alabama is a cluster unto itself. The University of South Carolina and CU-Boulder form a cluster. The third cluster consists of nine universities (Arkansas, Kansas, Cincinnati, San Diego, Rutgers, Amherst, Pitt, Berkeley, and Georgia). Finally, the fourth cluster -- Nebraska-Lincoln, UC-Riverside, and SUNY-Stony Brook -- consists of universities that are all peripheral to the network but do not visit any high schools in common.
...
The three most central universities in Figure \@ref(fig:plot-1mode-privu) are the universities which visited the greatest number of different private high schools, identified in parentheses: Notre Dame (625), Villanova (563), and SMU (550). Visually, the second tier of centrality includes TCU (435), Tulane (430), Northwestern (377), and Boston College (339). These results are fairly consistent with the four clusters identified by cluster analysis, in which Notre Dame and SMU are both clusters unto themselves, and Villanova is part of the third cluster which also includes Northwestern, Boston College, Tulane, and TCU.

With respect to the periphery of the network -- Baylor (237), Stevens Institute (160), Marquette (331), and Case Western (228) --  Baylor visits a higher number of conservative Chrisitan high schools than any other university (see Figure \@ref(fig:religion-pubu-privu)). It is notable that Marquette is in the periphery despite visiting a higher number of schools than more centrally located universities (e.g., Emory), suggesting that Marquette visits many schools that are visited by few other private universities in our sample.
...
Figure \@ref(fig:plot-1mode-u) shows overlap in private high schools visited amongst all 29 private and public universities in the sample, with the cluster analysis algorithm specified to identify five groups. 

Two clusters -- consisting of 10 universities -- emerge as the most central. The first cluster, consisting of four universities (with number of unique private high schools visited in parentheses), is the University of Alabama (759), Notre Dame (625), Villanova (563), and SMU (550). These four universities visited more private high schools than all other universities in our sample. [COMMENT ON NUMBER OF SCHOOLS IN COMMON]. With respect to the characteristics of private high schools visited, these universities made a relatively large share of visits at Catholic schools, at schools in the South (less so for Notre Dame), and at low-ranked schools (less so for SMU). 

The second most central cluster, consisting of six universities, is the University of South Carolina (396), Northwestern (377), TCU (435), Tulane (430), CU-Boulder (362), and Boston College (339). With respect to characteristics of private high schools visited, these universities made a relatively large share of visits at schools in the South (less so for Boston College), and a large share of visits to Catholic and nonsectarian schools (except many visits to Christian schools by TCU), and tended to visit higher private schools than universities in the first cluster. 

An important substantive takeaway is that the most central universities in the network consist of a mix of private (seven universities) and public (three universities). When we restrict the cluster analysis to identify four groups (not shown) rather than five groups, these 10 universities become one group. Thus, with respect to which private high schools they visit, the seven private universities in this group seem to have more in common with the three public universities in the group than the do with other private universities in our sample. Similarly, the three public universities in the group seem to have more in common with the seven private universities than they do with other public universities in our sample. 

The third cluster consists of 5 private universities -- Emory(), Case Western (), Tufts, University of Denver, Marquette (X) -- and 2 public universities -- UMass Amherst () and University of Georgia (). By contrast, the fourth cluster consists of consists of 7 public universities -- UC-Berkeley, UC San Diego, University of Pittsburgh, Rutgers, University of Cincinnati, University of Kansas, and University of Arkansas -- and 2 private universities -- Baylor () and Stevens Institute of Technology (). While the third cluster contains more private universities than public and the fourth cluster contains more public universities than private, it is interesting that clusters did not emerge based soley on private/public. The only cluster that does not contain both public and private unviersities is the cluster five -- -- which consists of universities visit relatively few private high schools a


BIG PICTURE TAKEWAY: WITH EXCEPTION OF MOST PERIPHERAL CLUSTER, ALL THE CLUSTERS CONTAIN BOTH PUBLIC AND PRIVATE UNIVERSTIES

- for majority of clusters, cluster includes both public and private universities, suggesting a great deal of overlap across public and private universities in terms of which private high schools they target. 


 Northwestern (377), TCU (435), Tulane (430), Boston College (339)
 
 Notre Dame (625), Villanova (563), and SMU (550). Visually, the second tier of centrality includes TCU (435), Tulane (430), Northwestern (377), and Boston College (339). 
 
 
Big picture findings:

- most central clusters
  - if k = 5 clusters, two most central clusters: 
    - University of Alabama, Notre Dame, Villanova, and SMU
    - University of South Carolina, Northwestern, TCU, Tulane, CU-Boulder, and Boston College.
  - if K= 4 clusters
    - U. Alabama, Notre Dame, Villanova, SMU, U South Carilona, Northwestern, TCU, Tulane, CU-Boulder, Boston College

  - 
most central in graph:

- Bama, Notre Dame


, directing the algorithm to identify four groups. 
