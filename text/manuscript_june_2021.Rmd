...
DESCRIBE HOW TO READ TABLE AND WHAT THE RESULTS SHOW
...
Figure \@ref(fig:plot-1mode-pubu) graphs the one-mode public university network. Generally -- whether graphing one-mode or two-mode networks -- network graphs show vertices as circles and edges as lines connecting pairs of vertices. In our one-mode public university network, each circle represents a public university and two universities share an edge -- represented by a dotted line -- if both universities visit at least one high school in common. 


For our one-mode public 
