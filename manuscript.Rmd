...
knitr::kable(
  ...
  caption = 'ego table caption') %>% landscape(margin = NULL) %>%
...
knitr::kable(
  df %>% select(-school_id,-closeness), caption = 'ego table 3') %>% 
...
knitr::kable(df, caption = 'ego table caption') %>% 
  landscape(margin = NULL) %>%
  kable_styling(latex_options = 'scale_down')
```
...
```{r two-mode-plot-privu, fig.align = 'center', echo = FALSE, out.width = "75%", fig.cap = "caption of 2 mode graph"}
...
```{r emory-region, fig.align = 'center', echo = FALSE, out.width = "75%", fig.cap = "Ego network of Emory University, with geographic region"}
knitr::include_graphics('assets/figures/emory_region.pdf')
```


```{r rank-cluster1, fig.align = 'center', echo = FALSE, out.width = "75%", fig.cap = "Academic rating of private high schools visited by selected colleges from cluster 1"}
knitr::include_graphics('assets/figures/rank_cluster1.pdf')
```

```{r race-cluster4, fig.align = 'center', echo = FALSE, out.width = "75%", fig.cap = "Racial composition of visited private high schools, selected colleges"}
