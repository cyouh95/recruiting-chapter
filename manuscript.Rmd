...
Figure \@ref(fig:villanova-religion) shows the ego network of Villanova University, with religious affiliation

Figure \@ref(fig:emory-region) shows the ego network of Emory University, with geographic region

Figure \@ref(fig:rank-cluster1) shows the academic reputation of private high schools visited by selected colleges universities in cluster 1

Figure \@ref(fig:race-cluster4) shows the racial composition of visited private high schools, selected colleges
...
df <- readRDS('./assets/tables/table_ego.RDS')
knitr::kable(
  df %>% select(ID,University,Cluster,Type,Rank,Characteristics,c1_lt10,c2_10to25,c3_25to50,`c4_50+`), row.names = F, # select(-ID, -Characteristics)
...
```{r villanova-religion, fig.align = 'center', echo = FALSE, out.width = "75%", fig.cap = "Ego network of Villanova University, with religious affiliation"}
