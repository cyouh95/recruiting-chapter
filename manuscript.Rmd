...
knitr::kable(
  df %>% select(-ID, -Characteristics), row.names = F, 
...
```{r two-mode-plot, fig.align = 'center', echo = FALSE, out.width = "125%", fig.cap = "caption of 2 mode graph"}
...
```{r two-mode-plot-privu, fig.align = 'center', echo = FALSE, out.width = "125%", fig.cap = "caption of 2 mode graph"}
