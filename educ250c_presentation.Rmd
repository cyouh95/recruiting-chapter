...
```{r event-count-figure-pubu, echo = FALSE, out.width="125%"}
...
```{r event-count-figure-privu, echo = FALSE, out.width="125%"}
...
CRYSTAL - CAN YOU ADD FOLLOWING FIGURES CURRENTLY INCLUDED IN MANUSCRIPT.PDF

- FIG 7, CHARACTERISTICS OF PRIVATE HS VISITED BY PRIVATE INSTITUTIONS
- FIG 11, CHARACTERISTICS OF PRIVATE HS VISITED BY PUBLIC INSTITUTIONS

## RQ3: Overlapping networks of visits to private high schools

CYSTAL - CAN YOU ADD FOLLOWING FIGURES CURRENTLY INCLUDED IN MANUSCRIPT.PDF

- FIG 10, 1-mode network for public institutions, colored by cluster
- FIG 12, 1-mode network for all institutions, out-of-state visits only for public universities, colored by cluster
