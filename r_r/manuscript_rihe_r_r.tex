...
{\centering \includegraphics[width=2\linewidth]{../assets/figures/plot_1mode_u} 
...
{\centering \includegraphics[width=2\linewidth]{../assets/figures/ego_network_region_pubu_privu} 
...
{\centering \includegraphics[width=2\linewidth]{../assets/figures/ego_network_religion_pubu_privu} 
