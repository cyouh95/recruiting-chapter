...
{\centering \includegraphics[width=2\linewidth]{../assets/figures/race_comp_pubu_privhs_pubhs} 

}

\caption{Racial composition of students at visited public high schools vs. visited private high schools in the South, public research universities}\label{fig:race-comp-pubu-privhs-pubhs}
\end{figure}
...
{\centering \includegraphics[width=2\linewidth]{../assets/figures/race_comp_privu_privhs_pubhs} 

}

\caption{Racial composition of students at visited public high schools vs. visited private high schools in the South, selective private universities}\label{fig:race-comp-privu-privhs-pubhs}
\end{figure}
...
{\centering \includegraphics[width=2\linewidth]{../assets/figures/plot_2mode_all} 
...
\caption{One-mode network for public research institutions, colored by cluster}\label{fig:plot-1mode-pubu}
\end{figure}
