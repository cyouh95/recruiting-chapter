...
Finally, Figure X examines the racial composition of private schools visited in the South (upper panel) and the racial composition of public schools visited in the South (lower panel) by public research universities in our sample. Figure X does the same for selective private universities. These figures are motivated by the finding that many universities in our sample visited a large number of private schools in the South, where private school enrollment growth has been the strongest [@RN4504]. For public research universities, Figure X shows that visited Southern private schools tended to enroll dramatically lower shares of Black/Latinx/Native students than visited Southern public schools. This was true for all public universities in our sample, and particularly for UNIVERSITY X, Y, Z. Results for selective private universities in Figure X mirror the results for public research universities. Quite simply, the racial composition of Southern private schools is dramatically different than the racial composition of Southern public schools and these differences are also reflected in schools that received visits. 
...
INSERT FIGURES X AND X ABOUT HERE
