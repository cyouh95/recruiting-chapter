...
Figures \@ref(fig:race-pubu-privhs-pubhs) and \@ref(fig:race-privu-privhs-pubhs) show the percentage of 12th graders who identify as Black, Latinx, or Native at visited high schools. Consistent with @RN4504, most private high schools enroll relatively few students from historically underrepresented race/ethnicity groups. The top row in the top panel of Figure \@ref(fig:race-pubu-privhs-pubhs) shows that the sum of Black, Latinx, and Native students comprise less than 20% of enrolled students in over 65%<!--0.6632124--> of schools in our private high school universe. At public high schools (bottom panel), Black/Latinx/Native students comprise less than 20% of enrolled students at around 40%<!--0.4087567--> of all public schools. However, most public research universities and all selective private universities visited private high schools at a higher rate than public high schools<!--TODO: I'm not too sure how to interpret "higher rate than public high schools" - should it be higher rate than proportional rate? Related, is the last sentence supposed to be "disproportionate emphasis on visits to" PRIVATE instead of "public schools"?-->, as seen earlier in Figures \@ref(fig:actual-proportional-pubu) and \@ref(fig:actual-proportional-privu). Even if universities visited schools with racial composition on par with the universe of private high schools, most visited schools would have relatively few Black/Latinx/Native students enrolled. Therefore, a disproportionate emphasis on visits to public schools may shift the racial composition of public universities away from Black/Latinx/Native students.
...
INSERT FIGURES \@ref(fig:race-comp-pubu-privhs-pubhs) AND \@ref(fig:race-comp-privu-privhs-pubhs) ABOUT HERE
