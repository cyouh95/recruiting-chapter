...
PX-PX: vignette of visits to a private high school.

Theories of organizational behavior suggest that university recruiting behaviors -- those that require significant resource expenditure -- are indicators of organizational enrollment priorities. Large, complex organizations consist of several "technical levels" responsible for processing inputs and producing outputs and "managerial levels" responsible for directing the technical level and tending to demands from the external environment [@RN531; @RN959]. The technical level cannot pursue multiple goals efficiently. Thus, organizations respond to external pressue to pursue multiple, competing goals goals by symbolically adopting some goals and substantively adopting others [@RN513]. Under symbolic adoption, organizations adopt policies and structures that send signals to external constituents but do not affect resource allocation in the technical level. Under substantive adoption, organizations direct resources in the technical level towards achieving the goal. Off-campus recruiting visits by admissions officers to local high schools and college fairs was the top-ranked recruiting expenditure item for both public and private universities, according to @RN4664. Therefore, analyses of which schools a university visits -- and which schools they ignore -- can yield insights about university enrollment goals.
...
A multidisciplinary literature on social stratification has analyzed relationship between private high schools and universities [CITE]. This research observes strong linkages -- and flows of students -- between private high schools and selective private universities [CITE]. To date, scholarship on nonresident enrollment by public universities has progressed in isolation from scholarship on linkages between private schools and private universities. We argue that these two stories are connected because public research universities are increasingly targeting out-of-state private schools, which have historically been the domain of selective private universities.
